...
pub const COLOR_MAP_BACKGROUND_SATURATED: types::Color = types::Color::new(0.0, 0.0, 1.0, 1.0);
pub const COLOR_MAP_BACKGROUND_EMPTY: types::Color = types::Color::new(0.5, 0.5, 1.0, 1.0);
