...
impl Seed {
    ...
    /// Gets the energy cost of building energy storage for a seed
    ///
    /// # Parameters
    ///
    ...
    /// Gets the base energy cost of building a new seed
    ///
    /// # Parameters
    ///
    /// map_settings: The general map settings
    ...
    /// Gets the energy gained by this seed this round
    ///
    /// # Parameters
    ///
    /// map_settings: The general map settings
