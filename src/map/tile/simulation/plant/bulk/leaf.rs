...
impl Leaf {
    ...
    /// Gets the energy cost factor of energy storage for a leaf
    ///
    /// # Parameters
    ///
    ...
    /// Gets the energy cost of building a new leaf
    ///
    /// # Parameters
    ///
    /// map_settings: The general map settings
    pub fn get_energy_cost_build(&self, map_settings: &Settings) -> f64 {
        return map_settings.energy.base.bulk.leaf + map_settings.energy.production.leaf / (1.0 - self.absorption);
    }
}
